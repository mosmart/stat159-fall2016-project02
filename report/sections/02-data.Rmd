...
To test our models, it was important for us to create training data (for the model to learn on) and testing data (to test how accurate our model is in predicting the response). Since our dataset contains 400 observations, our _training set_ is comprised of 300 random samples, and our _testing  set_ is 100 observations.
